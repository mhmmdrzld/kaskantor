		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<?php if( ! empty($kwitansi)){
					foreach($kwitansi as $data){ $data['kode_kwitansi']; $id=$data['id'];}}?>
				<div class="modal-body">
					<form data-toggle="validator" method="post" action="<?php echo base_url("keperluan/save"); ?>">
						<?php if($data['statuskas']=="Mess"){?>
							<button class="btn btn-info btn-rounded" type="button" id="btn-tambah-formkepmodmess">Tambah Data Form</button>
							<button class="btn btn-info btn-rounded" type="button" id="btn-reset-formkepmodmess">Reset Form</button><br><br>
						<?php ;}else{ ?>
						...
						<table>
							<div class="form-row">
								<td>
									<div class="col">
										<label class="control-label">Nama Keperluan</label>
										<input type="hidden" class="form-control"  name="zzz" value="<?php echo $id;?>">
										<input type="hidden" class="form-control"  name="kode_kwitansi" value="<?php echo $data['kode_kwitansi'];?>">
										<input type="hidden" class="form-control"  name="statuskas" value="<?php echo $data['statuskas'];?>">
										<input type="text" class="form-control" placeholder="Nama Keperluan" name="nama_keperluan[]" required>
									</div>
								</td>
								<td>
				...
				<div id="insert-formkepmodmess"></div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-info waves-effect btn-rounded" data-dismiss="modal">Tutup</button>
				<button type="submit" class="btn btn-info waves-effect btn-rounded">Simpan</button>
