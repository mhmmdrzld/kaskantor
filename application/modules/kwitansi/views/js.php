...
$(document).ready(function () { // Ketika halaman sudah diload dan siap
	...
	//tambah field keperluan
$(document).ready(function () { // Ketika halaman sudah diload dan siap
		$("#btn-tambah-formkepmodmess").click(function () { // Ketika tombol Tambah Data Form di klik
			var jumlah = parseInt($("#jumlah-formkepnmodmess").val()); // Ambil jumlah data form pada textbox jumlah-form
			var nextform = jumlah + 1; // Tambah 1 untuk jumlah form nya

			// Kita akan menambahkan form dengan menggunakan append
			// pada sebuah tag div yg kita beri id insert-form
			$("#insert-formkepmodmess").append(
				"<table>" +
				"<div class='form-row'>" +
				"<td>" +
				"<div class='col'>" +
...
" 							</td> "+
			...
			$("#jumlah-formkepmodmess").val(nextform); // Ubah value textbox jumlah-form dengan variabel nextform
		});

		// Buat fungsi untuk mereset form ke semula
		$("#btn-reset-formkepmodmess").click(function () {
			$("#insert-formkepmodmess").html(""); // Kita kosongkan isi dari div insert-form
			$("#jumlah-formkepmodmesss").val("1"); // Ubah kembali value jumlah form menjadi 1
		});
	});
